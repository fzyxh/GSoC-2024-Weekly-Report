...
::: {.column width="50%"}
<img src="./image/r code chunk.svg" style="zoom:75%;" />
:::
:::
...
::: {style="color: #ff2c2d;opacity: .5;"}
1. detect code chunks
:::

::: {.fragment .highlight-red}
::: {.fragment .fade-out}
2. detect code chunks
:::
:::
...
::: {.column width="50%"}
1. convert code chunks
2. convert code chunks
:::
:::

[Preview](./example_articles/a.html){preview-link="true"}

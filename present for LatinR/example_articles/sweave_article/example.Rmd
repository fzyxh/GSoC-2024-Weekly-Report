...
```{r , echo=FALSE , fig.cap="R logo", fig.alt="graphic without alt text", fig.show='hold', fig.align="center", out.width="50.0%"}
knitr::include_graphics(c("Rlogo.png"))
```
